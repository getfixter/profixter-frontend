...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sticky toolbar */}
      <div className="sticky top-[60px] md:top-[64px] z-40 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur">
        <div className="px-3 md:px-8 py-3 md:py-4">
          <AdminTabs active={active} onChange={setActive} />
          <div className="md:hidden rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <div className="mt-1 text-xs text-slate-500">
                  Switch sections from the bottom dock and keep filters close.
                </div>
              </div>
      ...
      {/* Content */}
      <div className="max-w-[1400px] mx-auto px-3 pb-28 pt-3 md:px-8 md:py-6">
        {loading ? (
