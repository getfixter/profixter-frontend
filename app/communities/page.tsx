...
export default function CommunitiesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F5F7FB] text-[#0B1628]">
      <section className="relative overflow-hidden bg-[#07111F] px-4 pb-20 pt-4 text-white sm:px-6 sm:pb-24 lg:px-8">
        ...
        <div className="relative mx-auto grid max-w-[1240px] gap-8 pt-9 sm:pt-18 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:pt-20">
          <div>
            ...
            <p className="mt-7 max-w-[640px] text-[17px] leading-8 text-white/70 sm:text-[19px]">
          ...
          <div className="-mt-14 mb-8 rounded-[16px] border border-white/70 bg-white/85 p-5 shadow-[0_24px_80px_rgba(15,23,42,0.12)] backdrop-blur sm:p-6 lg:p-7">
            <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-2 text-[23px] font-black leading-tight tracking-[-0.03em] text-[#0B1628] sm:text-[26px]">
      ...
      <section className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[1240px]">
          <div className="max-w-[720px]">
            ...
            <h2 className="mt-3 text-[30px] font-black tracking-[-0.04em] text-[#0B1628] sm:text-[40px]">Useful for residents. Simple for management.</h2>
          </div>
        ...
        <div className="mx-auto max-w-[1240px] rounded-[34px] bg-[#0B1628] p-6 text-white shadow-[0_28px_90px_rgba(15,23,42,0.18)] sm:p-9 lg:p-12">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <h2 className="mt-3 text-[30px] font-black leading-tight tracking-[-0.04em] sm:text-[36px]">Everyday help homeowners actually need.</h2>
      ...
      <section className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-[1240px] gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-3 text-[30px] font-black tracking-[-0.04em] sm:text-[40px]">Community value without adding operational burden.</h2>
        ...
        <div className="mx-auto max-w-[1240px] rounded-[34px] border border-[#DDE5F0] bg-white p-6 shadow-[0_24px_80px_rgba(15,23,42,0.07)] sm:p-9 lg:p-12">
          <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-3 text-[30px] font-black tracking-[-0.04em] sm:text-[36px]">Built locally for a better home service experience.</h2>
              <p className="mt-5 text-[16px] leading-8 text-[#64748B]">
      ...
      <section id="partnership-form" className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-[1240px] gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div className="lg:sticky lg:top-8">
            ...
            <h2 className="mt-3 text-[30px] font-black tracking-[-0.04em] sm:text-[40px]">Let’s explore whether Profixter is a good fit for your community.</h2>
            <p className="mt-5 text-[16px] leading-8 text-[#64748B]">
          ...
          {status === "success" ? (
            <div className="rounded-[16px] border border-[#BBE6C7] bg-[#F1FBF4] p-7 shadow-[0_24px_80px_rgba(15,23,42,0.08)] sm:p-9">
              ...
              <h3 className="mt-5 text-[26px] font-black text-[#0B1628]">Request received</h3>
      ...
      <section className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[1240px]">
          <div className="mb-7 max-w-[720px]">
            ...
            <h2 className="mt-3 text-[30px] font-black tracking-[-0.04em] sm:text-[36px]">Questions boards and managers usually ask.</h2>
          </div>
