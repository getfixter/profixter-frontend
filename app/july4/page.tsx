...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Basic includes 90-minute handyman visits, with one visit booked at a time. It is designed for common small and medium home-maintenance tasks that can be completed within the visit time. Materials and work outside the membership scope may cost extra.",
  },
  {
    question: "How many visits do I get each month?",
    answer:
      "Membership isn't a set number of visits per month. Book as often as you need — Basic lets you have one visit booked at a time, and once it is done you can book the next. Scheduling is subject to availability.",
  },
  {
...
function SectionHeading({
  ...
  return (
    <div className={centered ? "mx-auto max-w-[760px] text-center" : "max-w-[680px]"}>
      ...
      <h2 className="mt-3 text-[26px] font-bold leading-[1.08] tracking-[-0.035em] text-[#101828] sm:text-[34px]">
        {title}
      </h2>
      {description ? (
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#F8F9FC] text-[#101828]">
      <header className="absolute inset-x-0 top-0 z-30">
        <div className="mx-auto flex max-w-[1240px] items-center justify-between px-5 py-5 sm:px-5 lg:px-8">
          <Link
            href="/"
      ...
      <section className="relative bg-[#08111F] pb-10 pt-24 text-white sm:pb-11 sm:pt-32 lg:min-h-[780px] lg:py-32">
        <Image
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-[1240px] gap-9 px-5 sm:px-5 lg:grid-cols-[1.25fr_0.75fr] lg:items-center lg:gap-10 lg:px-8">
          <div className="max-w-[700px] pt-[38vh] sm:pt-[32vh] lg:pt-0">
            ...
            <h1 className="mt-5 max-w-[690px] text-[34px] font-bold leading-[1.01] tracking-[-0.045em] sm:text-[43px] lg:text-[46px]">
      ...
      <section className="border-b border-[#E4E7EC] bg-white px-5 py-5 sm:px-5 lg:px-8">
      ...
      <section className="px-5 py-10 sm:px-5 sm:py-15 lg:px-8">
      ...
      <section id="how-it-works" className="border-y border-[#E4E7EC] bg-white px-5 py-10 sm:px-5 sm:py-15 lg:px-8">
        <div className="mx-auto max-w-[1120px]">
          <SectionHeading
      ...
      <section className="bg-[#EEF3FF] px-5 py-10 sm:px-5 sm:py-15 lg:px-8">
        <div className="mx-auto grid max-w-[1120px] items-start gap-7 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          <div>
            <SectionHeading
              centered={false}
      ...
      <section className="bg-white px-5 py-10 sm:px-5 sm:py-15 lg:px-8">
      ...
      <section className="bg-[#0A1424] px-5 py-10 text-white sm:px-5 sm:py-15 lg:px-8">
        <div className="mx-auto grid max-w-[1080px] items-center gap-7 lg:grid-cols-[0.8fr_1.2fr] lg:gap-10">
          ...
          <div>
            ...
            <h2 className="mt-3 text-[26px] font-bold leading-[1.08] tracking-[-0.035em] sm:text-[34px]">
      ...
      <section className="bg-[#F8F9FC] px-5 py-10 sm:px-5 sm:py-15 lg:px-8">
        <div className="mx-auto max-w-[1120px]">
          <SectionHeading
      ...
      <section className="border-y border-[#E4E7EC] bg-white px-5 py-10 sm:px-5 sm:py-15 lg:px-8">
      ...
      <section className="relative overflow-hidden bg-[#07111F] px-5 py-10 text-center text-white sm:px-5 sm:py-15 lg:px-8">
        ...
        <div className="relative mx-auto max-w-[780px]">
          ...
          <h2 className="mt-5 text-[30px] font-bold leading-[1.05] tracking-[-0.04em] sm:text-[40px]">
      ...
      <footer className="bg-[#050B14] px-5 pb-28 pt-8 text-white sm:px-5 sm:pb-8 lg:px-8">
