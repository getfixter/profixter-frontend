...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.password || !formData.phone || 
        !formData.address || !formData.city || !formData.zip || !formData.county) {
    ...
    <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-24 sm:py-32">
      ...
      >
          <div className="flex gap-6 sm:gap-8 mb-8 sm:mb-12">
            <Link href="/signin" className="text-xl sm:text-2xl font-medium pb-2 text-white/60 hover:text-white transition-colors">
              Sign in
            </Link>
            <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-x-12 sm:gap-y-8">
              ...
              <div>
                <PasswordField
                  ...
                  inputClassName="w-full pb-2 sm:pb-3 text-sm sm:text-base"
                  iconSize={20}
                />
              </div>
              <div>
              ...
              <div>
                <select
                  ...
                  required
                >
                  <option value="" className="bg-[#313234] text-white">Select County</option>
                  <option value="Nassau" className="bg-[#313234] text-white">Nassau</option>
                  <option value="Suffolk" className="bg-[#313234] text-white">Suffolk</option>
                </select>
              </div>
