...
export const plans: Plan[] = [
  {
    ...
    price: 149,
    features: ['1 Visit at the time', 'Labor Included', 'Up to 90 Minutes'],
  ...
  },
  {
    ...
    features: ['Store Trip', 'Standard materials', 'Better coverage'],
    buttonText: 'Get started Free',
  ...
  },
  {
    ...
    features: ['24/7 emergency visit', '2 Handyman Oprion', 'After Hours'],
    buttonText: 'Get started Free',
    isPopular: true,
