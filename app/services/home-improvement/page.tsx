    ...
    try {
      const res = await fetch(`${API_BASE}/api/requests/public`, {
        ...
        body: JSON.stringify({
          ...
          sourcePage: "/services/home-improvement",
        }),
      });
            ...
            {submitted ? (
              <div className="max-w-2xl mx-auto rounded-2xl border border-[#86EFAC] bg-[#E6F8EC] p-6 text-center">
                ...
                <p className="text-[#22543D] mb-5">
                  We’ll contact you soon. But if you want future work to be easier and
                  better organized, do not leave it here.
                </p>

                <div className="text-lg font-bold text-[#143D28] mb-4">
                  Create your Mr. Fixter account now and put your home in the system the right way.
                </div>
