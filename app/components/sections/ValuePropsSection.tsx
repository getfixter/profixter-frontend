      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-gray-600">Book appointments online 24/7. Eligible plans include Priority Visits when you need help sooner, subject to technician availability.</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-[#E6F8EC] text-[#34A853] flex items-center justify-center mb-3">
              <span className="text-2xl">💬</span>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border-collapse text-sm text-left">
            ...
            <tbody>
              ...
              <tr>
                <td className="px-4 py-2 border-b border-gray-200">Priority Visit</td>
