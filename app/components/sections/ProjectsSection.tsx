      ...
      <div className="max-w-[1240px] mx-auto px-[20px]">
        ...
        <div className="lg:hidden">
          ...
          <div className="relative">
            ...
            <div className="flex gap-3 justify-center mt-6">
              <button
                onClick={prevSlide}
                className="bg-[#EEF2FF] hover:bg-white text-[#313234] w-[52px] h-[52px] rounded-[12px] flex items-center justify-center shadow-md"
              >
          ...
          <p className="text-[#C5CBD8] text-sm sm:text-base text-center mt-8 max-w-md mx-auto">
        ...
        <div className="hidden lg:flex items-start gap-12">
          <div className="flex-shrink-0 w-[390px] pt-4 flex flex-col justify-between">
            <div>
              <h2 className="text-[64px] font-bold leading-[69%] uppercase tracking-[-0.05em]">
                <span className="text-[#EEF2FF]">OUR </span>
                <span className="text-[#306EEC]">LATEST</span>
              </h2>
              <h2 className="text-[64px] font-bold leading-[89%] uppercase text-[#EEF2FF] tracking-[-0.05em] mb-2">
                PROJECT
              </h2>

              <p className="text-[#C5CBD8] text-base mb-5 max-w-[291px]">
                Real examples of house maintenance work we do and more.
              </p>
              ...
              <button
                type="button"
                onClick={goToBooking}
                className="w-[362px] h-[60px] bg-[#306EEC] hover:bg-[#2558c7] text-[#EEF2FF] rounded-[14px] text-[20px] font-semibold mb-44"
              >
                Fix it today
              </button>
            </div>

            <p className="text-[#C5CBD8] text-[15px] max-w-[272px]">
              Every project we take on is built on trust, skill, and attention to detail.
            </p>
          </div>
          ...
          <div className="relative min-h-[506px]">
            <div className="relative flex items-center gap-6 ml-16">
              <div className="relative w-[450px] h-[450px] rounded-[20px] shadow-[0_10px_80px_rgba(0,0,0,0.25)]">
                <Image
                  src={projects[currentSlide].image}
                  alt="Project Image"
                  width={450}
                ...
                <div className="flex gap-3 absolute bottom-0 -right-34">
                  <button
                    onClick={prevSlide}
                    className="bg-[#EEF2FF] w-[52px] h-[52px] rounded-[12px] flex items-center justify-center"
                  >
                    <svg width="24" height="24" viewBox="0 0 24 24">
                      <path
                        d="M15 18L9 12L15 6"
                ...
                {[1, 2].map((offset) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <div className="absolute inset-0 bg-[#313234]/30 backdrop-blur-[3px] rounded-[10px]" />
                    </div>
                  );
                })}
              </div>
