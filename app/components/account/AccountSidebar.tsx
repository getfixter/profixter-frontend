...
const menuItems: {
  ...
  /*
   * No visits tab. Visits live under Book, and ?tab=bookings now redirects
   * there, so listing it here offered a destination that immediately sends the
   * customer somewhere else. The overview keeps a View Visits shortcut.
   */
  {
    key: "plan",
    label: "Membership",
