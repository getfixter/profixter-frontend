...
export default function StepsSection() {
  return (
    <section className="w-full bg-white h-full py-12 sm:py-16 lg:py-24 flex items-center justify-center mb-16 sm:mb-32 lg:mb-60">
      <div className="container mx-auto px-[20px] max-w-[1240px]">
        <div className="relative w-full lg:w-[1209px] mx-auto">
          {/* Decorative text - left */}
          <div className="hidden lg:block absolute top-0 left-0 text-base text-[#6a6c71] leading-[19px]">
            A clean process for a cozy life.
          </div>

          {/* Main Heading */}
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-5xl lg:text-[64px] font-bold leading-tight sm:leading-[48px] lg:leading-[57px] text-[#313234] lg:mr-15">
              <span className="text-[#313234]">JUST </span>
              <span className="text-[#306eec]">3</span>
              <span className="text-[#313234]"> STEPS</span>
            </h2>
            <h2 className="text-3xl sm:text-5xl lg:text-[64px] font-bold leading-tight sm:leading-[48px] lg:leading-[57px] text-[#313234] mt-1 lg:ml-15">
          ...
          <div className="relative mt-12 sm:mt-20 lg:mt-32">
            ...
            <div className="lg:hidden flex flex-col gap-12 sm:gap-16">
              ...
              <div className="text-center sm:text-left">
                <div className="relative inline-block mb-6">
                  ...
                  <div className="absolute -bottom-2 left-1/2 sm:left-8 -translate-x-1/2 sm:translate-x-0 w-4 h-4 bg-[#306eec] rounded-full"></div>
                </div>
            ...
            <div className="hidden lg:block">
              ...
              <div className="absolute -top-30 -left-8 w-[295px]">
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    {/* Blue dot */}
                    <div className="absolute top-[133px] left-[49px] w-5 h-5 bg-[#306eec] rounded-full"></div>
                  </div>
                </div>
              </div>

              {/* Step 02 */}
              <div className="absolute top-8 left-1/2 -translate-x-1/2 w-[309px] text-center">
                <div className="relative">
              ...
              {/* Step 03 */}
              <div className="absolute -top-35 -right-5 w-[221px] text-right">
                <div className="relative">
                  <h3 className="text-2xl font-semibold text-[#313234] leading-[21px] mb-4">
                  ...
                  <div className="relative inline-block">
                    ...
                    {/* Blue dot */}
                    <div className="absolute top-[134px] left-[98px] w-5 h-5 bg-[#306eec] rounded-full"></div>
                  </div>
                </div>
              </div>
            </div>
